...
function drawHowToPlay() {
    ...
    if (planetOverview) {
        image(planetOverview, imageX, imageY, planetOverview.width * 0.6, planetOverview.height * 0.6);
    }
...
🕹 Controls: 
	...
	•	Mouse click = Shoot (Take 10 hits and you’re out)
...
💡 Final Tips:
	•	Get to know how each ship looks and know their powers. 
...
function handlePlayerMovement2() {
    ...
    if (myCharacterData.canCloake && me.isCloaked) {
        localSpeed = Math.max(1, localSpeed / 2);
    }
